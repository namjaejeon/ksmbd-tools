 ...
 */
#define CIFSD_RPC_COMMAND_METHOD_RETURN		(1 << 0)
#define CIFSD_RPC_COMMAND_RAP			(1 << 1 | \
						CIFSD_RPC_COMMAND_METHOD_RETURN)
#define CIFSD_RPC_COMMAND_SRVSVC_METHOD_INVOKE	(1 << 2)
#define CIFSD_RPC_COMMAND_SRVSVC_METHOD_RETURN	(1 << 2 | \
						CIFSD_RPC_COMMAND_METHOD_RETURN)
#define CIFSD_RPC_COMMAND_WKSSVC_METHOD_INVOKE	(1 << 3)
#define CIFSD_RPC_COMMAND_WKSSVC_METHOD_RETURN	(1 << 3 | \
						CIFSD_RPC_COMMAND_METHOD_RETURN)
#define CIFSD_RPC_COMMAND_IOCTL			(1 << 4 | \
						CIFSD_RPC_COMMAND_METHOD_RETURN)

#define CIFSD_RPC_COMMAND_OPEN			(1 << 5)
#define CIFSD_RPC_COMMAND_READ			(1 << 6 | \
						CIFSD_RPC_COMMAND_METHOD_RETURN)
#define CIFSD_RPC_COMMAND_WRITE			(1 << 7)
#define CIFSD_RPC_COMMAND_CLOSE			(1 << 8)

#define CIFSD_RPC_COMMAND_OK			0
#define CIFSD_RPC_COMMAND_ERROR_BAD_FUNC	0x00000001
#define CIFSD_RPC_COMMAND_ERROR_BAD_FID		0x00000006
#define CIFSD_RPC_COMMAND_ERROR_NOMEM		0x00000008
#define CIFSD_RPC_COMMAND_ERROR_BAD_DATA	0x0000000D
#define CIFSD_RPC_COMMAND_ERROR_NOTIMPLEMENTED	0x00000040
#define CIFSD_RPC_COMMAND_ERROR_MORE_DATA	0x000000EA
#define CIFSD_RPC_COMMAND_ERROR_INVALID_LEVEL	0x0000007C
